...
describe("parseRecipeLine", () => {
  test("should return the result for two quantities and units with math", () => {
    const result = parseRecipeLine("1 cup plus 2 tablespoons flour");
  ...
  test("should return the result for a range quantity", () => {
    const result = parseRecipeLine("1-2 cups granulated sugar");
    expect(result).not.toBeUndefined();
  ...
  test("should return the result for a simple quantity", () => {
    const result = parseRecipeLine("1/2 cup chocolate chips");
    expect(result).not.toBeUndefined();
  ...
  test("should return the metric result for a line that has it", () => {
    const result = parseRecipeLine("1 cup (120 g) flour");
    expect(result).not.toBeUndefined();
...
describe("findClosestKeySingle and findClosestKey", () => {
  ...
  test("should return the closest key string for 2 ingredients", () => {
    ...
    expect(findClosestKey("greek yogurt or sour cream")).toEqual("Sour cream");
  });
...
describe("getGramsFromMetricMeasurement", () => {
  test("should return the correct grams for a range in ounces", () => {
    expect(
      getGramsFromMetricMeasurement(
        ["(10 - 12 ounces)", "10", "12", "ounce"],

        true,
        true
      )
    ).toEqual([283.5, 340.19]);
  });

  test("should return the correct grams for a measurement in ounces", () => {
    expect(
      getGramsFromMetricMeasurement(["1 oz", "1", "oz"], true, false)
    ).toEqual(28.35);
  });

  test("should return the correct grams for a range in grams", () => {
    expect(
      getGramsFromMetricMeasurement(
        ["100 - 110 grams", "100", "110", "gram"],
  ...
  test("should return the correct grams for a measurement in mls", () => {
    expect(
      getGramsFromMetricMeasurement(
        ["60 ml", "60", "ml"],
